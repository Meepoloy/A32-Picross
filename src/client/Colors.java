...
public class Colors extends JFrame {
     ...
     * Colors constructor
     * 
     * @param control ClientController object
     */
    Colors(ClientController control) {
     ...
     */
    private JPanel colorPanel(ClientController control) {
     ...
     * @return returns a JPanel
     */
    private JPanel optionPanel(ClientController control) {
