...
public class ClientGameFrame extends JFrame {
    ...
    ClientGameFrame(int index, ClientController control) {
     ...
     * @param control Controller class
     */
    private void setLeftPanel(ClientController control) {
     ...
     * @param control Controller class
     */
    private void setTopPanel(ClientController control) {
     ...
     * @param control Controller class
     */
    private void setRightPanel(ClientController control) {
        ...
        JScrollPane scrollV = new JScrollPane(control.getEventLogDuplicate());
        scrollV.setPreferredSize(new Dimension(180, 480));
        control.getEventLogDuplicate().append(control.getLabel("GAMEMSG") + "\n");
        ...
        control.getPoints().setEditable(false);
        ...
        control.getTimer().setEditable(false);
        ...
        control.getTextFields()[4].addFocusListener(control);
        control.getTextFields()[4].setText(control.getLabel("CHATMSG"));
        chatPanel.add(control.getTextFields()[4]);
        // JButton sendButton = new JButton();
        // control.setSendButton();
        control.getSendButton()[1].setActionCommand("SEND1");
        control.getSendButton()[1].addActionListener(control);
        control.getSendButton()[1].setOpaque(false);
        control.getSendButton()[1].setContentAreaFilled(false);
        control.getSendButton()[1].setBorderPainted(false);
        control.getSendButton()[1].setBorder(null);

        if (control.isConnected()) {
            control.getSendButton()[1].setEnabled(true);
            control.getTextFields()[4].setEnabled(true);
        } else {
            control.getSendButton()[1].setEnabled(false);
            control.getTextFields()[4].setEnabled(false);
        }
        JLabel logo = new JLabel();
        logo.setIcon(new ImageIcon("images/gamesendicon.png"));
        control.getSendButton()[1].add(logo);
        chatPanel.add(control.getSendButton()[1]);
        chatPanel.add(Box.createRigidArea(new Dimension(10, 0)));
        chatPanel.addFocusListener(control);

        comPanel.add(scrollV);
        comPanel.add(chatPanel);
    ...
    /**
     * Method for setting menu bar
     * 
     * @param control ClientController control
     */
    private void setMenuBar(ClientController control) {
